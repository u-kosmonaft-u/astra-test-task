...
Vagrant.configure("2") do |config|
  ...
  # using a specific IP.
  config.vm.network "private_network", ip: "10.20.10.25" # "192.168.33.10"
  ...
  config.vm.synced_folder "./system", "/opt/system"
  ...
  config.vm.provision "ansible_local" do |ansible|
      ansible.provisioning_path = "/opt/ansible"
      ansible.playbook = "/opt/ansible/install_docker.yml"
    end
